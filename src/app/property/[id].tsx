...
import { ownedAndLive, currentUserId, requireUserId } from '@/db/owner';
...
import {
  ...
  METHOD_LABELS, PAYMENT_STATUS_LABELS, PAYMENT_STATUS_TONE,
  formatMoney, formatPeriod, formatDate, deleteCascadeWarning, type Currency,
} from '@/lib/domain';
...
export default function PropertyDetailScreen() {
  ...
  async function handleSavePayment(rows: PaymentInput[]) {
    ...
    try {
      await savePayments(activeLease.id, paymentModal.mode, rows, paymentModal.payment);
      await loadData();
